...
export const Home = () => {
  ...
  const renderSection = (title: string, isCircular: boolean = false) => (
    ...
    <div className={`flex flex-col gap-8 pb-20 mt-4 relative z-10 ${!user ? 'px-2' : ''}`}>
      ...
      {!user ? (
        <>
          ...
          {renderSection("Popular artists", true)}
          {renderSection("Popular albums and singles")}
          {renderSection("Popular radio")}
          {renderSection("Featured Charts")}
